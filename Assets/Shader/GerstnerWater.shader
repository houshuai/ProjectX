	...
	SubShader 
	{
		...
		Pass
		{
			...
			v2f vert (appdata v)
			{
				Wave W[5] = 
				{
					{ 1.350, 0.2, 1.5, float2(-0.5, 0.2), 2 },
					{ 0.220, 0.1, 1.3, float2(-0.7, 0.7), 10 },
					{ 1.3020, 0.03, 1.5, float2(0.5, 0.2), 5 },
					{ 1.420, 0.2, 1.60, float2(0.8, -0.20), 1 },
					{ 1.220, 0.2, 1.32, float2(0.2, 0.10), 2 }
				};
